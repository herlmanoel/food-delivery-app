  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: listProducts.isEmpty
          ? _notContentPage()
          : _contentPage(widthSafeArea, provider, listProducts),
    );
  }
  ...
  Widget _contentPage(var widthSafeArea, var provider, var listProducts) {
    return Column(
      ...
      children: <Widget>[
        ...
        _productsShoppingCart(widthSafeArea, listProducts, provider),
      ],
    );
  }

  Widget _productsShoppingCart(widthSafeArea, listProducts, provider) {
